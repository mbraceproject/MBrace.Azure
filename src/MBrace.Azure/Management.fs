...
type VMSizes() = 
    ...
    static member A4 = VMSize "ExtraLarge" // A4
    static member A0 = VMSize "ExtraSmall" // A0
    static member A3 = VMSize "Large" // A3
    static member A2 = VMSize "Medium" // A2
    static member A1 = VMSize "Small" // A1
    static member Extra_Large = VMSize "ExtraLarge" // A4
    static member Large = VMSize "Large" // A3
    static member Medium = VMSize "Medium" // A2
    static member Small = VMSize "Small" // A1
    static member Extra_Small = VMSize "ExtraSmall" // A0
...
type Management() = 
    ...
    static member CreateCluster(pubSettingsFile, Region region, ?ClusterName, ?Subscription, ?MBraceVersion, ?VMCount, ?StorageAccount, ?VMSize, ?CloudServicePackage, ?ClusterLabel) =
       trial { 
           let (VMSize vmSize) = defaultArg VMSize VMSizes.Large
